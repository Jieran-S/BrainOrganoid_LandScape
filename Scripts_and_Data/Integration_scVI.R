...
#Clustering
seurat_combi <- RunUMAP(seurat_combi, reduction="scvi", dims = 1:10, reduction.name = 'scvi_umap',reduction.key="UMAPscVI_")
seurat_combi <- FindNeighbors(seurat_combi, reduction = "scvi", dims = 1:10, graph.name = 'scvi_snn') %>%
...
pdf(file="Visualization/Integration_scVI.pdf",
    width = 24,
    height = 24)
